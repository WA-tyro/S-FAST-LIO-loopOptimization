...
typedef Sophus::SO3<double> MySO3;

//24维的状态量x
struct state_ikfom
{
	Eigen::Vector3d pos = Eigen::Vector3d(0,0,0);
	MySO3 rot = MySO3(Eigen::Matrix3d::Identity());
	MySO3 offset_R_L_I = MySO3(Eigen::Matrix3d::Identity());
...
Eigen::Matrix<double, 24, 24> df_dx(state_ikfom s, input_ikfom in)
{
	...
	cov.block<3, 3>(12, 3) = -s.rot.matrix() * MySO3::hat(acc_);		//对应公式(7)第3行第1列
